...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if ($round > 1) {
        $now_HP = $db->prepare("SELECT HP FROM bround WHERE round = ?");
    ...
    // get atk
    $get_damage = $db->prepare("SELECT damage FROM around WHERE round = ?");
